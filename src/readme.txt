...
templates folder:
  ...
  -create_user.html: renders create user page, sends username and password to database; if successful, directs to c_user_success.html, else directs to c_user_fail.html
